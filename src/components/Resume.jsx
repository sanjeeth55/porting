...
const Resume = () => {
  ...
  return (
    <section
      id="resume"
      className="pt-0 pb-16 md:pt-0 md:pb-24 bg-gradient-to-br from-blue-50/50 to-purple-50/50"
    >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 bg-gray-900 text-white rounded-xl font-bold flex items-center justify-center gap-3 hover:bg-gray-800 transition-all hover:scale-105 shadow-md group"
            >
              <Eye
                size={20}
